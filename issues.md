...
| 2026-04-27 | frontend | Site never opened in a real browser during the build (sandbox blocked local server, Pages live URL not visually inspected). Tabs, marker cluster, and side-panel interactions are unverified. | Tooling. | Open — needs a manual smoke test or a Playwright UAT pass. |
