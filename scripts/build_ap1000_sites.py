...
SITES = [
    ...
    },
    {
        ...
        "water_note": "Mojave Desert; AV basin in chronic overdraft with documented land subsidence (>1 ft over 292 sq mi). No major river/reservoir — base buys finished water from AVEK. A wet-cooled AP1000 is not a practical assumption here; dry-cooling is effectively required.",
    ...
    },
    {
        ...
        "water_distance_mi": 8, "water_adequacy": "marginal",
        "water_note": "Belton Lake (~210,600 ac-ft) supplies the post via Bell County WCID #1, but semi-arid central TX means an AP1000's ~15-20 MGD consumptive makeup would be a meaningful share of basin yield. The Leon River itself is small/seasonal, so this should be treated as water-constrained rather than comfortably adequate.",
    ...
    },
    {
        ...
        "water_note": "The Kirkwood-Cohansey is a huge high-yield aquifer, but PFAS contamination + NJ Pinelands water-allocation limits would complicate a 30-40 MGD withdrawal, and there is no large river adjacent. Treat as technically possible but materially constrained.",
